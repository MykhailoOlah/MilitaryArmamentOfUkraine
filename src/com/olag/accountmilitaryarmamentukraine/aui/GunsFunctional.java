...
public class GunsFunctional {
        ...
        if (gunToEdit != null) {
            ...
            while (true) {
                ...
                try {
                    ...
                    System.out.println("Неправильний формат ціни. Будь ласка, введіть число.");
                }
            }
    ...
    /**
     * Приватний метод для знаходження об'єкта Guns за назвою в списку зброї.
     *
     * @param gunName   Назва зброї для пошуку.
     * @param gunsList  Список об'єктів Guns.
     * @return          Об'єкт Guns, якщо зброю знайдено, в іншому випадку - null.
     */
